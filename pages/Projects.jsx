...
const MyProjects = () => (
  <SectionWrapper className="flex-col py-24">
    <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
      <NeonGlow className="top-20 left-10 w-72 h-72 bg-cyan-900/10 blur-[120px]" />
      <NeonGlow className="bottom-20 right-10 w-72 h-72 bg-purple-900/10 blur-[120px]" />
    </div>

    <div className="z-10 w-full max-w-6xl">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-4">
          Featured <GradientText>Creations</GradientText>
        </h1>
