...
const Header = () => {
  ...
  return (
    <SectionWrapper className="flex-col">
      <NeonGlow className="top-[-10%] left-[-10%] w-125 h-125 bg-cyan-900/20 blur-[120px] animate-pulse" />
      <NeonGlow className="bottom-[-10%] right-[-10%] h-150 w-150 bg-purple-900/20 blur-[150px] animate-bounce duration-[10s]" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-20">
        ...
        <h1 className="text-5xl md:text-8xl font-black text-white leading-[1.1] mb-8 tracking-tighter">
          Crafting <GradientText variant="cyan-blue-purple" className="drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">Digital</GradientText> <br />
          Experiences.
        </h1>
