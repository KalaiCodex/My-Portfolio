...
const Skills = () => (
  <SectionWrapper className="flex-col py-24">
    <NeonGlow className="top-[-10%] left-[-10%] w-96 h-96 bg-cyan-900/20 blur-[120px]" />
    <NeonGlow className="bottom-[-10%] right-[-10%] w-96 h-96 bg-purple-900/20 blur-[120px]" />

    <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-16 tracking-wider z-10 text-center">
      My <GradientText className="drop-shadow-[0_0_15px_rgba(192,132,252,0.5)]">Tech Arsenal</GradientText> ⚡
    </h2>
