...
import { SectionWrapper, NeonGlow, GradientText } from "../src/components";
import { RESUME_PATH, WHATSAPP_URL } from "../src/constants";
import Myphoto from "../public/assets/AnimeKalai.jpeg";

const Career = () => (
  <SectionWrapper tag="section" className="py-20">
    <NeonGlow className="top-1/2 left-[-10%] w-125 h-125 bg-blue-900/10 blur-[150px]" />
    <NeonGlow className="bottom-0 right-[-5%] w-100 h-100 bg-purple-900/10 blur-[130px]" />
    ...
    <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center z-10">
      ...
      <div className="text-left space-y-6">
        ...
        <h2 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
          I&apos;m <GradientText>Kalai Selvan</GradientText>, <br />
          a Digital Craftsman.
        </h2>
        ...
        <div className="flex flex-wrap gap-4 pt-6">
          <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-linear-to-r from-cyan-600 to-blue-600 text-white px-8 py-3 rounded-full font-bold hover:shadow-[0_0_20px_rgba(34,211,238,0.4)] hover:-translate-y-1 transition-all duration-300">
            Let&apos;s Connect
          </a>
          <a
            href={RESUME_PATH}
